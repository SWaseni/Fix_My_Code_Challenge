...
OBOBOB    if user_2.password is not None:
...
OBOBOB        print("is_valid_password should return True if it's the right \
password")

    if user_1.is_valid_password("Fakepwd"):
OBOBOB        print("is_valid_password should return False if it's not the right \
password")
